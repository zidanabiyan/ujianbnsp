...
<header id="header" class="header fixed-top" data-scrollto-offset="0">
    <div class="container-fluid d-flex align-items-center justify-content-between">
        <a href="index.html" class="logo d-flex align-items-center scrollto me-auto me-lg-0">
            <img src="{{ asset('herobiz/assets/img/logo.png') }}" alt="TrashTrack Logo" class="logo" style="width: 50px; height: auto;">
        </a>

        <nav id="navbar" class="navbar">
            <ul>
                <li><a class="nav-link scrollto" href="index.html#home">Beranda</a></li>
                <li><a class="nav-link scrollto" href="{{ route('profile') }}">Profil Sekolah</a></li>
                <li><a class="nav-link scrollto" href="{{ route('ekskul') }}">Ekstakulikuler</a></li>
...
<section id="hero-animated" class="hero-animated d-flex align-items-center">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="5000">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{ asset('herobiz/assets/img/slider1.jpg') }}" class="d-block w-100" alt="Gambar 1">
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('herobiz/assets/img/slider2.jpg') }}" class="d-block w-100" alt="Gambar 2">
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('herobiz/assets/img/slider3.jpg') }}" class="d-block w-100" alt="Gambar 3">
                </div>
            </div>
  ...
  <img src="{{ asset('herobiz/assets/img/logo.png') }}" alt="TrashTrack Logo" style="max-width: 150px;"> <!-- Sesuaikan path logo dan ukuran maksimal -->
<h1><strong>YAYASAN IKHLAS</strong></h1>
  <p>"Belajar disaat orang lain tidur; bekerja sementara yang lain bermalas malasan; mempersiapkan disaat orang lain bermain; dan bermimpi sementara lainnya sedang berharap." - William Arthur Ward</p>
</div>
  ...
  <div class="col-lg-5">
    <div class="about-img">
      <img src="{{ asset('herobiz/assets/img/sekolah1.jpg') }}" class="img-fluid" alt="">
    </div>
  </div>
  <div class="col-lg-7 align-self-center"> <!-- Tambahkan class align-self-center untuk vertikal centering -->
    <h3 class="pt-0 pt-lg-"><strong>Pendidikan adalah senjata paling kuat yang bisa kamu gunakan untuk mengubah dunia</strong></h3>
...
<div class="tab-pane fade show active" id="tab1">
  ...
  <p class="fst-italic">Misi kami adalah menyediakan alat dan informasi yang dibutuhkan untuk meningkatkan pendidikan di masyarakat. Kami berdedikasi untuk:</p>

  <div class="d-flex align-items-center mt-4">
    <i class="bi bi-check2"></i>
    <h4>Meningkatkan Akses Pendidikan</h4>
  </div>
  <p>Dengan teknologi terbaru, kami mendukung upaya untuk meningkatkan akses dan kualitas pendidikan di berbagai wilayah.</p>

  <div class="d-flex align-items-center mt-4">
    <i class="bi bi-check2"></i>
    <h4>Mendorong Inovasi Pendidikan</h4>
  </div>
  <p>Kami berkomitmen untuk mendorong inovasi dalam pendidikan, termasuk penggunaan teknologi untuk pembelajaran yang lebih efektif.</p>

  <div class="d-flex align-items-center mt-4">
    <i class="bi bi-check2"></i>
    <h4>Membangun Masyarakat Pendidikan</h4>
  </div>
  <p>Kami bekerja sama dengan berbagai pihak untuk membangun masyarakat pendidikan yang inklusif dan berkelanjutan.</p>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <h4>Mantan Walikota Surabaya</h4>
                <div class="stars">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                </div>
                <p>
                  <i class="bi bi-quote quote-icon-left"></i>
                  Aplikasi bank sampah ini sangat membantu! Saya bisa dengan mudah mengatur jadwal pengumpulan sampah dan melihat berapa banyak poin yang sudah saya kumpulkan. Interface-nya user-friendly dan informatif. Terima kasih!
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <h3>David Christian</h3>
                <h4>Co-founder &amp; CEO Evoware</h4>
                <div class="stars">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                </div>
                <p>
                  <i class="bi bi-quote quote-icon-left"></i>
                  Sangat puas dengan aplikasi ini. Menukar sampah dengan poin yang bisa ditukar dengan berbagai hadiah adalah ide yang brilian. Selain itu, saya juga merasa lebih termotivasi untuk mendaur ulang.
                  <i class="bi bi-quote quote-icon-right"></i>
                </p>
              </div>
            </div><!-- End testimonial item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <h3>Tiza Mafira</h3>
                <h4>Direktur GIDKP</h4>
                <div class="stars">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                </div>
                <p>
                  <i class="bi bi-quote quote-icon-left"></i>
                  Aplikasi sering mengalami crash dan loadingnya lama. Harap segera diperbaiki agar pengguna bisa lebih nyaman menggunakannya.
                  <i class="bi bi-quote quote-icon-right"></i>
                </p>
              </div>
            </div><!-- End testimonial item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <h3>Prigi Arisandi</h3>
                <h4>Aktivis Lingkungan &amp; Pendiri Ecoton</h4>
                <div class="stars">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                </div>
                <p>
                  <i class="bi bi-quote quote-icon-left"></i>
                  Informasi tentang lokasi bank sampah sering tidak akurat. Saya beberapa kali kesulitan menemukan tempat yang sesuai dengan yang tertera di aplikasi.
                  <i class="bi bi-quote quote-icon-right"></i>
                </p>
              </div>
            </div><!-- End testimonial item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <h3>Samsudin Sadari</h3>
                <h4>Pengelola Bank Sampah Gemah Ripah, Bantul</h4>
                <div class="stars">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                </div>
                <p>
                  <i class="bi bi-quote quote-icon-left"></i>
                  Mungkin bisa dipertimbangkan untuk menambahkan fitur tutorial atau panduan penggunaan aplikasi bagi pengguna baru. Selain itu,penambahan fitur chat untuk bertanya langsung ke customer service juga akan sangat berguna.
                  <i class="bi bi-quote quote-icon-right"></i>
                </p>
              </div>
            </div><!-- End testimonial item -->
...
<div class="container" data-aos="fade-up">
    ...
    <div class="section-header">
        ...
        <p>Berita Terkait YAYASAN IKHLAS</p>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="post-box">
                <div class="post-img">
                    <img src="{{ asset('assets/img/blog/berita1.jpg') }}" class="img-fluid" alt="Berita 1">
                </div>
                <div class="meta">
                    <span class="post-date">Tue, December 12</span>
                    <span class="post-author"> / Julia Parker</span>
                </div>
                <h3 class="post-title">Inovasi Terbaru dalam Pengelolaan Sampah di Sekolah</h3>
                <p>Deskripsi singkat tentang berita ini yang menjelaskan tentang inovasi terbaru dalam pengelolaan sampah di sekolah.</p>
        ...
        <div class="col-lg-4" data-aos="fade-up" data-aos-delay="400">
            <div class="post-box">
                <div class="post-img">
                    <img src="{{ asset('assets/img/blog/blog-2.jpg') }}" class="img-fluid" alt="Berita 2">
                </div>
                <div class="meta">
                    <span class="post-date">Fri, September 05</span>
                    <span class="post-author"> / Mario Douglas</span>
                </div>
                <h3 class="post-title">Pelatihan Tim Ekstrakurikuler Bola di Sekolah</h3>
                <p>Deskripsi singkat tentang berita ini yang menjelaskan tentang pelatihan tim ekstrakurikuler bola di sekolah.</p>
                <a href="blog-details.html" class="readmore stretched-link"><span>Read More</span><i class="bi bi-arrow-right"></i></a>
            </div>
        </div>
        ...
        <div class="col-lg-4" data-aos="fade-up" data-aos-delay="600">
            <div class="post-box">
                <div class="post-img">
                    <img src="{{ asset('assets/img/blog/blog-3.jpg') }}" class="img-fluid" alt="Berita 3">
                </div>
                <div class="meta">
                    <span class="post-date">Tue, July 27</span>
                    <span class="post-author"> / Lisa Hunter</span>
                </div>
                <h3 class="post-title">Pameran Seni Siswa-siswi YAYASAN IKHLAS</h3>
                <p>Deskripsi singkat tentang berita ini yang menjelaskan tentang pameran seni yang diadakan oleh siswa-siswi YAYASAN IKHLAS.</p>
                <a href="blog-details.html" class="readmore stretched-link"><span>Read More</span><i class="bi bi-arrow-right"></i></a>
            </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <h3>YAYASAN IKHLAS</h3>
              <p>
                Serang,Banten,Indonesia <br>
                535022<br><br>
                <strong>Phone:</strong> +62 9872382902<br>
                <strong>Email:</strong> yayasanikhlas@gmail.com<br>
              </p>
            </div>
          </div>
          ...
          <div class="copyright">
            &copy; Copyright <strong><span>YAYASAN IKHLAS</span></strong>2024
          </div>
